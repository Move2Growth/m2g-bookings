...
| **(B)** | **Cuatro de las seis fotos de marca no existen** | Luis | `docs/marca/BRANDBOOK-BUKEO.md` §02 | Se generaron dos (uñas y spa) y **el generador se quedó sin crédito** en las otras cuatro. Mientras tanto las seis categorías sin foto son celdas de color plano, que es más honesto que una imagen de banco genérica y además pesa cero en 3G. Se cierra con crédito nuevo, no con código |
