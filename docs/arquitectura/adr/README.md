...
| [0019](0019-el-acceso-es-correo-y-contrasena.md) | El acceso es correo y contraseña | aceptada | **Supera la parte de la 0006** que hacía del código la única puerta. El teléfono deja de ser obligatorio para existir y se pide al reservar; verificarlo **no abre sesión** |
| [0020](0020-el-profesional-es-una-entidad-de-primera.md) | El profesional es una entidad de primera | aceptada | Perfil público propio y elegible antes que el local. Slug único **por negocio**, y de las redes se guarda el usuario y nunca la URL |
